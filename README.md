...
1. Right-click on `table_explorer_runner1.bat` and select **Edit**.
2. Find the line that says: `set "ENV_NAME=JIP_env"`
3. Change `JIP_env` to the name of the virtual environment where you have installed the required libraries (pandas, pyqt5).
4. Save and close. You are now ready to double-click and run!
